...
\input{solutions/unoptimized/Unoptimized}
\newpage

\subsection{Operation Chaining Solution}
\input{solutions/operation_chaining/OperationChaining}
\newpage

\subsection{Code Hoisting Solution}
\input{solutions/code_hoisting/CodeHoisting}
\newpage

\subsection{Loop Fission Solution}
\input{solutions/loop_fission/LoopFission}
\newpage

\subsection{Loop Unrolling Solution}
\input{solutions/loop_unrolling/LoopUnrolling}
\newpage

\subsection{Loop Pipelining Solution}
\input{solutions/loop_pipelining/LoopPipelining}
\newpage

\subsection{Bitwidth Optimization Solution}
\input{solutions/bitwidth_optimization/BitwidthOptimization}
\newpage

\subsection{AXI Solution}
\input{solutions/axi/AXI}